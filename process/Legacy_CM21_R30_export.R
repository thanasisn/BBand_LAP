...
Sys.setenv(TZ = "UTC")
tic <- Sys.time()
Script.Name <- "~/BBand_LAP/process/Legacy_CM21_R30_export.R"
renv::load("~/BBand_LAP")
...
for (YYYY in datayears) {
    ...
    legacyout <- paste0("~/DATA/Broad_Band/CM21_H_signal/LAP_CM21_H_S1_", YYYY, ".Rds")
    ...
    year_data$CM21_sig_wo_dark[!is.na(year_data$cm21_bad_data_flag)] <- NA
    ...
    names(year_data)[names(year_data) == "CM21_sig_wo_dark"] <- "CM21valueWdark"
...
# $ Azimuth       : num  51.2 51.6 52 52.4 52.8 ...
# $ Elevat        : num  -64.2 -64.1 -63.9 -63.8 -63.6 ...
# $ QFlag_1       : logi  NA NA NA NA NA NA ...
# $ CM21valueWdark: num  NA NA NA NA NA NA NA NA NA NA ...

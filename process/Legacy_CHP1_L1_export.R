...
# $ Date30        : POSIXct, format: "2023-01-01 00:00:30" "2023-01-01 00:01:30" ...
# $ CHP1value     : num  -6.30e-05 2.90e-04 1.45e-04 -3.05e-05 -1.37e-04 ...
# $ CHP1sd        : num  0.000948 0.001197 0.001005 0.001126 0.000864 ...
# $ AsynStep      : int  NA NA NA NA NA NA NA NA NA NA ...
# $ Async         : logi  FALSE FALSE FALSE FALSE FALSE FALSE ...
# $ Azimuth       : num  53.6 54 54.4 54.8 55.1 ...
# $ Elevat        : num  -64.3 -64.1 -64 -63.8 -63.7 ...
...
# $ Date          : POSIXct, format: "2023-01-01 00:00:00" "2023-01-01 00:01:00" ...
...
for (YYYY in datayears) {
    ...
    wecare <- grep("TSI|Astropy", names(year_data), value = TRUE, ignore.case = TRUE, invert = TRUE)
